package com.example.sonworks.fragmentactivitysample.fragment;
...
//        }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final Button aButton = (Button) view.findViewById(R.id.bButtonId);
        aButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragmentManager.beginTransaction().replace(R.id.fragmentLayoutId, AFragment.newInstance(PARAM1, PARAM2)).commit();
            }
        });
    }
}
